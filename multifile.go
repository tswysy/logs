...
var levelNames = [...]string{"fatal", "alert", "panic", "error", "warning", "notice", "info", "debug"}
...
//	"rotate":true,
//  	"perm":0600,
//	"separate":["fatal", "alert", "panic", "error", "warning", "notice", "info", "debug"],
//	}
...
func (f *multiFileLogWriter) Init(config string) error {
	...
	for i := LevelFatal; i < LevelDebug+1; i++ {
